...
@section('content')
        ...
        <div class="container">
            <div class="hero-grid">
                <div class="hero-content">
                    ...
                    <p>Gokidz memberikan ketenangan pikiran bagi Orang Tua dengan layanan jemput anak sekolah yang aman dan
                        terpantau real-time. Perjalanan jadi seru dan menyenangkan bagi anak-anak!</p>
                ...
                <div class="hero-illustration">
                    ...
                    <img src="{{ asset('images/gokidz_islamic_hero.png') }}" class="shuttle-art"
                        alt="Gokidz School Shuttle Bus"
                        style="width: 100%; max-width: 500px; border-radius: var(--radius-lg); box-shadow: var(--shadow-lg); z-index: 2;">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Kami berkomitmen menyediakan layanan antar jemput dengan standar keselamatan tertinggi dan fasilitas yang
                    disukai anak-anak.</p>
            </div>
            ...
            <div class="features-grid">
                ...
                <div class="feature-card orange">
                    ...
                    <p>Setiap armada/driver dilengkapi dengan aplikasi gokidz dengan GPS tracker aktif agar Ayah & Bunda
                        bisa memantau posisi anak secara real-time.</p>
                </div>
                <!-- Card 2 -->
                ...
                <div class="feature-card green">
                    ...
                    <p>Pemberitahuan otomatis melalui aplikasi gokidz ketika anak dijemput, sampai di sekolah, dan saat
    ...
    <!-- Cara Kerja Section -->
    <section class="section"
        style="background-color: var(--white); border-top: 3px solid var(--primary-light); border-bottom: 3px solid var(--primary-light)">
        <div class="container">
            <div class="section-header">
        ...
        <div class="container">
            ...
            <div class="features-grid">
                <div class="feature-card" style="text-align: left; background: var(--white)">
                    ...
                    <p style="font-style: italic; margin-bottom: 20px; color: var(--text-muted)">"Sangat terbantu dengan
                        Gokidz! Saya bekerja kantoran dan tidak sempat mengantar anak. Berkat notifikasi GPS-nya, saya bisa
                        memantau dengan tenang."</p>
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <div style="font-size: 2.2rem;">👩‍💼</div>
                        <div>
                            <h4 style="font-size: 1.05rem;">B******A.</h4>
                            <span style="font-size: 0.8rem; color: var(--text-muted)">Bunda dari K*** </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card" style="text-align: left; background: var(--white)">
                    <div style="font-size: 1.5rem; margin-bottom: 10px; color: var(--accent-yellow)">⭐⭐⭐⭐⭐</div>
                    <p style="font-style: italic; margin-bottom: 20px; color: var(--text-muted)">"Mobilnya bersih dan
                        drivernya sangat ramah anak. Anak saya malah selalu bersemangat menunggu jemputan setiap pagi."</p>
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <div style="font-size: 2.2rem;">👨‍💼</div>
                        <div>
                            <h4 style="font-size: 1.05rem;">A********o</h4>
                            <span style="font-size: 0.8rem; color: var(--text-muted)">Ayah dari N*****</span>
                        </div>
                    </div>
                </div>
            </div>
